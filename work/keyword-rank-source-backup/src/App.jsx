...
export default function App() {
  ...
  const saveAnnotation = (payload) => runAction(
    ...
    () => api.setAnnotation({ ...payload, modelName: model.modelName, metric: 'sp' }),
      ...
      <div className="app-shell">
        ...
        <main className="main-area">
          ...
          <div className="content-area view-transition" key={`${model.parentAsin}-${activeTab}-${selectedDate}`}>
            ...
            {activeTab === 'natural' && <MatrixView model={model} metric="natural" selectedDate={selectedDate} onToggleWatch={toggleWatch} />}
        ...
        <SettingsModal open={settingsOpen} onClose={() => setSettingsOpen(false)} onResetWidths={resetWidths} />
        <BusyOverlay label={busyLabel} />
        <Toast toast={toast} onClose={() => setToast(null)} />
      </div>
    </div>
