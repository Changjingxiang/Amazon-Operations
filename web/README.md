...
- `data/initial-data.js` and `data/关键词排名每日跟进表.xlsx` are the v2.0
...
They were therefore extracted byte-for-byte from the confirmed v2.0 release
