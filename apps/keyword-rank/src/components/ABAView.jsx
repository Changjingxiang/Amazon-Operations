...
export default function ABAView({ model, rows: filteredRows, filters, onFiltersChange, onToggleWatch }) {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => { setHovered(null); if (!frame) frame = window.requestAnimationFrame(updateRange); };
